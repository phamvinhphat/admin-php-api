...
class RoleRepository implements IRoleRepository
{
    ...
    public function listAdmin()
    {
        return DB::table('role')
            ->select('account.id as id_user', 'account.avatar','account.last_name', 'account.phone_number','account.username', 'account.email','account.first_name', 'role.name as roleName','account.created_at', 'account.updated_at')
