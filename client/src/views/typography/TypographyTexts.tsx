                ...
                <Grid container spacing={6}>
                    ...
                    <DemoGrid item xs={12} sm={10}>
                        <Typography
                            ...
                            sx={{ marginBottom: 2 }}
                        >
                            Cupcake ipsum dolor sit amet chocolate bar pastry
                            sesame snaps.
                        </Typography>
                        <Typography variant="body2">
                            font-size: 16px / line-height: 28px / font-weight:
                            400
                        </Typography>
                    </DemoGrid>
                    ...
                    <DemoGrid item xs={12} sm={10}>
                        ...
                        <Typography variant="body2">
                            font-size: 14px / line-height: 21px / font-weight:
                            500
                        </Typography>
                    </DemoGrid>
                    ...
                    <DemoGrid item xs={12} sm={10}>
                        ...
                        <Typography variant="body2" sx={{ mt: 2 }}>
                            font-size: 14px / line-height: 17px / font-weight:
                    ...
                    <DemoGrid item xs={12} sm={10}>
                        ...
                        <Typography variant="body2" sx={{ mt: 2 }}>
                            font-size: 12px / line-height: 15px / font-weight:
                            400
                        </Typography>
                    </DemoGrid>
