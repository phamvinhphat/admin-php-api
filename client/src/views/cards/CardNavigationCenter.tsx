                ...
                <CardContent sx={{ textAlign: 'center' }}>
                    <TabPanel value="1" sx={{ p: 0 }}>
                        ...
                        <Typography variant="body2" sx={{ marginBottom: 4 }}>
                            Pudding tiramisu caramels. Gingerbread gummies
                            danish chocolate bar toffee marzipan. Wafer wafer
                    ...
                    <TabPanel value="2" sx={{ p: 0 }}>
                        ...
                        <Typography variant="body2" sx={{ marginBottom: 4 }}>
                            Dragée chupa chups soufflé cheesecake jelly tootsie
                            roll cupcake marzipan. Carrot cake sweet roll gummi
                    ...
                    <TabPanel value="3" sx={{ p: 0 }}>
                        ...
                        <Typography variant="body2" sx={{ marginBottom: 4 }}>
                            Icing cake macaroon macaroon jelly chocolate bar.
                            Chupa chups dessert dessert soufflé chocolate bar
